			...
			<div style="width: 100%; height: 100%; padding: 0px; margin: 0px;">
				<el-row>
					<el-col :span="18" style="display: flex; align-items: center;">
						<el-tooltip effect="dark" :content="item.attr.attrName" placement="top">
						  <span style="text-overflow: clip; white-space: nowrap; overflow: hidden; width: 100%;max-width: 100%;">{{ item.attr.attrName }}</span>
						</el-tooltip>
					</el-col>
